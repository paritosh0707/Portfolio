    ...
    <div className="App">
      ...
      <section id="about" className="about">
        <div className="about-content">
          ...
          <p>Brief introduction about yourself, your expertise, and what makes you unique.</p>
        </div>
      </section>
      ...
      <footer className="footer">
        <p className="copyright">&copy; 2024 [Your Name]. All rights reserved.</p>
        {/* Social media links */}
      ...
      <div className="portfolio-content">
        ...
        <div className="portfolio-grid">
          ...
          <PortfolioCard
            ...
            link="/project1" // Specify the link to redirect to
          />
